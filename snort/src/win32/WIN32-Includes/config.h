/* $Id: config.h,v 1.35.2.2 2006/05/03 19:09:38 ssturges Exp $ */
 ...
 */
#define VERSION "2.6.0RC2"VERSION_ENABLE_ODBC""VERSION_ENABLE_MYSQL""VERSION_ENABLE_MSSQL""VERSION_ENABLE_ORACLE""VERSION_ENABLE_RESPONSE"-WIN32"VERSION_DEBUG
