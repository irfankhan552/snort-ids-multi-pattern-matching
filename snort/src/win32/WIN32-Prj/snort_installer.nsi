; $Id: snort_installer.nsi,v 1.11.2.3 2006/05/03 19:09:38 ssturges Exp $
;
; NSIS Installation script for Snort 2.6.0 RC2 Win32
; Written by Chris Reid <chris.reid@codecraftconsultants.com>
;
; This script will create a Win32 installer for Snort 2.6.0 RC2 (Win32 only).
...
;Configuration
  ...
  ;General
  OutFile "Snort_26_Installer.exe"  ; The name of the installer executable
