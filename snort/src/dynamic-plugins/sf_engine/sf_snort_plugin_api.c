 ...
 * 
 *          p: packet data structure, same as the one found in snort.
 *  flowFlags: data defined in the detection plugin for this rule asn1 option
 *
 * Returns: 
 *    > 0 : match found
 *    = 0 : no match found
 ...
 * 
 *          p: packet data structure, same as the one found in snort.
 *   flowBits: data defined in the detection plugin for this rule asn1 option
 *
 * Returns: 
 *    > 0 : match found
 *    = 0 : no match found
 ...
 * 
 *          p: packet data structure, same as the one found in snort.
 *       asn1: data defined in the detection plugin for this rule asn1 option
 *     cursor: current position within buffer
 *
 * Returns: 
 *    > 0 : match found
