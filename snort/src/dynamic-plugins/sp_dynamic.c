/* $Id: sp_dynamic.c,v 1.1 2006/01/19 16:58:37 ssturges Exp $ */
/*
 * sp_dynamic.c
 *
 ...
 *
 ****************************************************************************/
int RegisterDynamicRule(u_int32_t sid, u_int32_t gid, void *info, OTNCheckFunction chkFunc, int fpContentFlags, GetFPContentFunction fpFunc)
{
    DynamicData *dynData;
