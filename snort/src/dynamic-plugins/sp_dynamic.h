...
/* $Id: sp_dynamic.h,v 1.1 2006/01/19 16:58:37 ssturges Exp $ */
...
int RegisterDynamicRule(u_int32_t gid, u_int32_t sid, void *info, OTNCheckFunction chkFunc, int fpContentFlags, GetFPContentFunction fpFunc);
