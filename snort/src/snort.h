...
/* $Id: snort.h,v 1.402.2.4 2006/02/27 21:33:28 ssturges Exp $ */
...
#define DYNAMIC_ENGINE            6
#define DUMP_DYNAMIC_RULES        7
#define DUMP_DYNAMIC_PREPROCS     8
#endif
#define ARG_RESTART               9
#define CREATE_PID_FILE           10
#define TREAT_DROP_AS_ALERT       11
#define PROCESS_ALL_EVENTS        12
#define ALERT_BEFORE_PASS         13
...
#define MAX_DYNAMIC_ENGINES 16
    ...
    char *dynamicEngine[MAX_DYNAMIC_ENGINES];
